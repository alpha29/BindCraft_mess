...
from colabdesign.af.loss import (_get_con_loss, get_dgram_bins, get_ptm,
                                 mask_loss)
...
def mpnn_gen_sequence(
    ...
    mpnn_sequences = mpnn_model.sample_parallel(
        temperature=advanced_settings["sampling_temp"],
        num=advanced_settings["num_seqs"],
        batch=advanced_settings["sample_seq_parallel"],
    )
